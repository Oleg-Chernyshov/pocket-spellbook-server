...
describe('CharactersController', () => {
  ...
  let characterSpellsService: CharacterSpellsService;
  ...
  const mockCharacterSpellsService = {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        {
          provide: CharacterSpellsService,
          useValue: mockCharacterSpellsService,
        },
      ],
    }).compile();
    ...
    characterSpellsService = module.get<CharacterSpellsService>(
  ...
  describe('getCharacterSpells', () => {
    it('should return localized spells of character with default language', async () => {
      ...
      (characterSpellsService.findByCharacter as jest.Mock).mockResolvedValue([
        { id: 5 },
      ]);
      ...
      expect(service.findOne).toHaveBeenCalledWith(1, 10);
      expect(characterSpellsService.findByCharacter).toHaveBeenCalledWith(
        1,
        'en',
      );
